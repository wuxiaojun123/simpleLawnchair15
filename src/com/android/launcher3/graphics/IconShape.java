...
public final class IconShape implements SafeCloseable {
    ...
    /**
     * Abstract shape where the reveal animation is a derivative of a round rect
     * animation
     */
    ...
    private static class TearDrop extends PathShape {
        ...
        /**
         * Radio of short radius to large radius, based on the shape options defined in
         * the config.
         */
        private final float mRadiusRatio;
        private final float[] mTempRadii = new float[8];
    ...
    private static class Squircle extends PathShape {
        ...
        /**
         * Radio of radius to circle radius, based on the shape options defined in the
         * config.
         */
        private final float mRadiusRatio;
